...
import { selectedSubjectAtom, sessionNameAtom, sessionStageAtom, siteNameAtom } from '../store/atoms';
...
export const NewSessionScreen: React.FC = () => {
  ...
  const handleContinue = () => {
    ...
    setSessionStage(selectedSubject ? 'sensor_configuration' : 'subject_selection');
