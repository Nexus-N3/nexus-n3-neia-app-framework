...
export const sessionStageAtom = atom<SessionStage>('idle');
export const subjectSensorRowsAtom = atom<SubjectSensorRows>({});
export const sessionEventsAtom = atom<NormalizedSessionEvent[]>([]);
export type { LogicalSensorRow };
